...
/**
 * All methods won't check clashes (e.g. {@link #write(T)} or existence (e.g.
 * {@link #delete(String)}). They are designed to be checked in {@link
 * ryey.easer.core.data.storage.AbstractDataStorage} and its subclasses.
 * @param <T>
 */
