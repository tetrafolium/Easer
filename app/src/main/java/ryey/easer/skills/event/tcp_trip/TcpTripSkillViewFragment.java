...
public class TcpTripSkillViewFragment
	extends SkillViewFragment<TcpTripEventData> {
...
public View onCreateView(final @NonNull LayoutInflater inflater,
	...
	View v =
		inflater.inflate(R.layout.plugin_event__tcp_trip, container, false);
	...
	b_check_reply.setOnCheckedChangeListener(
...
public TcpTripEventData getData() throws InvalidDataInputException {
	...
	return new TcpTripEventData(rAddr, rPort, send_data, check_reply,
	                            reply_data);
}
}
