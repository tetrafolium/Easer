...
public abstract class SelfNotifiableSlot<T extends EventData>
	extends AbstractSlot<T> {
// Fields used in relevant Intent
private static final String ACTION_SATISFIED =
	"ryey.easer.triggerlotus.abstractslot.SATISFIED";
private static final String ACTION_UNSATISFIED =
	"ryey.easer.triggerlotus.abstractslot.UNSATISFIED";
private static final String CATEGORY_NOTIFY_SLOT =
	"ryey.easer.triggetlotus.category.NOTIFY_SLOT";
/*
...
protected SelfNotifiableSlot(final @NonNull Context context,
