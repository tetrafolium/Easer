...
class CalendarHelper {
  ...
  static Long nextEvent_start(final ContentResolver contentResolver,
                              final long calendar_id) {
    ...
    Cursor cur =
        contentResolver.query(uri, EVENT_PROJECTION, selection, selectionArgs,
  ...
  static Long nextEvent_end(final ContentResolver contentResolver,
                            final long calendar_id) {
    final String[] EVENT_PROJECTION = new String[] {
        CalendarContract.Events._ID,     // 0
        CalendarContract.Events.DTSTART, // 1
