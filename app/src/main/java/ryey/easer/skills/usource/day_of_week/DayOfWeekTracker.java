...
public class DayOfWeekTracker
	extends SelfNotifiableSkeletonTracker<DayOfWeekUSourceData> {
...
DayOfWeekTracker(final Context context, final DayOfWeekUSourceData data,
	...
	Calendar cal = Calendar.getInstance(); // TODO: Make "super()" call
	                                       // "state()" and remove all these
...
private void scheduleAlarm() {   // FIXME: not sure if this method is correct
	...
	PendingIntent pendingIntent =
		state() ? notifySelfIntent_negative : notifySelfIntent_positive;
	...
	mAlarmManager.setInexactRepeating(
		AlarmManager.RTC_WAKEUP, calendar.getTimeInMillis(), 0, pendingIntent);
}
