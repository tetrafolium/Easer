...
public class BTDeviceSkillViewFragment
    extends SkillViewFragment<BTDeviceUSourceData> {
  private final String ACTION_RETURN =
      "ryey.easer.skills.combined.bluetooth_device.return_from_dialog";
  private final String EXTRA_HARDWARE_ADDRESS =
      "ryey.easer.skills.combined.bluetooth_device.extra.hardware_address";
  ...
  public View onCreateView(final @NonNull LayoutInflater inflater,
    ...
    View view = inflater.inflate(R.layout.plugin_usource__bluetooth_device,
                                 container, false);
    ...
    editText.addTextChangedListener(new TextWatcher() {
      final String name_not_found =
          getResources().getString(R.string.usource_bt_device_unknown_device);
        ...
        .setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(final View v) {
            ...
            builderSingle.setTitle(
                R.string.usource_bt_device_select_dialog_title);
            final ArrayAdapter<BTDeviceWrapper> arrayAdapter =
                ...
                arrayAdapter, new DialogInterface.OnClickListener() {
                  ...
                  public void onClick(final DialogInterface dialog,
                    ...
                    String hardware_address =
                        arrayAdapter.getItem(which).device.getAddress();
  ...
  class BTDeviceWrapper {
    ...
    BTDeviceWrapper(final BluetoothDevice device) { this.device = device; }
    public String toString() { return device.getName(); }
  }
}
