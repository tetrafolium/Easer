...
public class PowerSkillViewFragment
    extends SkillViewFragment<PowerUSourceData> {
  ...
  public View onCreateView(@NonNull LayoutInflater inflater,
    ...
    View view = inflater.inflate(R.layout.skill_usource__power_status,
                                 container, false);

    rg_status = view.findViewById(R.id.rg_status);
    ViewGroup layout_charging_tune =
        view.findViewById(R.id.layout_charging_tune);
    rg_status.setOnCheckedChangeListener(
          ...
          public void onCheckedChanged(RadioGroup group, int checkedId) {
            if (checkedId == R.id.rb_charging)
              ...
              throw new IllegalStateException(
                  "Charging status radio group check changed to unknown element");
          }
        });
