...
public class CellularOperationSkill implements OperationSkill<CellularOperationData> {
    ...
    @NonNull
    @Override
    public OperationLoader<CellularOperationData> loader(final @NonNull Context context) {
