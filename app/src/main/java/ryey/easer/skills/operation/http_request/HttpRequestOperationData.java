...
public class HttpRequestOperationData implements OperationData {
  ...
  @NonNull final String requestHeader;
  @NonNull final String contentType;
  @NonNull final String postData;

  HttpRequestOperationData(final @NotNull RequestMethod requestMethod,
                           final @NotNull String url,
                           final @NotNull String requestHeader,
                           final @NotNull String contentType,
                           final @NotNull String postData) {
  ...
  HttpRequestOperationData(final @NonNull String data,
    ...
    default:
      try {
        ...
        requestMethod =
            RequestMethod.valueOf(jsonObject.getString(K_REQUEST_METHOD));
  ...
  public boolean equals(final Object o) {
    ...
    return requestMethod.equals(that.requestMethod) && url.equals(that.url) &&
        requestHeader.equals(that.requestHeader) &&
        contentType.equals(that.contentType) && postData.equals(that.postData);
  }

  @Override
  public int hashCode() {
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
      return Objects.hash(requestMethod, url, requestHeader, contentType,
                          postData);
    } else {
      return requestHeader.hashCode() * 31 * 31 * 31 * 31 +
          url.hashCode() * 31 * 31 * 31 + requestHeader.hashCode() * 31 * 31 +
          contentType.hashCode() * 31 + postData.hashCode();
    }
  }
  ...
  public static final Creator<HttpRequestOperationData> CREATOR =
      new Creator<HttpRequestOperationData>() {
  ...
  private HttpRequestOperationData(final Parcel in) {
    requestMethod =
        (RequestMethod)Objects.requireNonNull(in.readSerializable());
