...
class CommandOperationDataFactory implements OperationDataFactory<CommandOperationData> {
    ...
    @NonNull
    @Override
    public CommandOperationData parse(final @NonNull String data, final @NonNull PluginDataFormat format, final int version) throws IllegalStorageDataException {
