...
class CellularOperationDataFactory implements OperationDataFactory<CellularOperationData> {
    ...
    @NonNull
    @Override
    public CellularOperationData parse(final @NonNull String data, final @NonNull PluginDataFormat format, final int version) throws IllegalStorageDataException {
