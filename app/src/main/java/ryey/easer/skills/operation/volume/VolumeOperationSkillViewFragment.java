...
public class VolumeOperationSkillViewFragment
    extends SkillViewFragment<VolumeOperationData> {
  ...
  public View onCreateView(final @NonNull LayoutInflater inflater,
    ...
    final View view =
        inflater.inflate(R.layout.plugin_operation__volume, container, false);
    ...
    checkBox_ring.setOnCheckedChangeListener(
    ...
    seekBar_bt.setMax(
        audioManager.getStreamMaxVolume(VolumeOperationSkill.STREAM_BLUETOOTH));
    et_bt_delay = view.findViewById(R.id.editText_bt_delay);
    checkBox_bt = view.findViewById(R.id.checkBox_bt);
    checkBox_bt.setOnCheckedChangeListener(
        new CompoundButton.OnCheckedChangeListener() {
          @Override
          public void onCheckedChanged(final CompoundButton compoundButton,
                                       final boolean b) {
  ...
  protected void _fill(final @ValidData @NonNull VolumeOperationData data) {
    ...
    setVolumeVisual(checkBox_notification, seekBar_notification,
                    data.vol_notification);
    setVolumeVisual(checkBox_bt, seekBar_bt, data.vol_bt);
    if (data.vol_bt != null) {
      String bt_delay_str =
          data.bt_delay == null ? "0" : data.bt_delay.toString();
  ...
  public VolumeOperationData getData() throws InvalidDataInputException {
    ...
    return new VolumeOperationData(vol_ring, vol_media, vol_alarm,
                                   vol_notification, vol_bt, bt_delay);
  }

  private static void setVolumeVisual(final CheckBox checkBox,
