...
public class MediaControlSkillViewFragment
    extends SkillViewFragment<MediaControlOperationData> {
  ...
  public View onCreateView(final @NonNull LayoutInflater inflater,
    ...
    View view = inflater.inflate(R.layout.plugin_operation__media_control,
                                 container, false);
