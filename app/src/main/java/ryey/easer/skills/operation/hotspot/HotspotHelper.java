...
boolean enableAp() throws NoSuchMethodException, IllegalAccessException,
InvocationTargetException {
	boolean apStatus = setApStatus(null, true);
	return apStatus;
}

boolean disableAp() throws NoSuchMethodException, IllegalAccessException,
InvocationTargetException {
	boolean apStatus = setApStatus(null, false);
	return apStatus;
}

boolean isApEnabled() throws NoSuchMethodException, InvocationTargetException,
IllegalAccessException {
	Method isWifiApEnabledmethod =
		wifiManager.getClass().getMethod("isWifiApEnabled");
	Boolean isWifiApEnabled =
		(boolean)isWifiApEnabledmethod.invoke(wifiManager);
	return isWifiApEnabled;
}

WifiConfiguration getApConfiguration() throws NoSuchMethodException,
InvocationTargetException,
IllegalAccessException {
...
boolean setApStatus(final WifiConfiguration netConfig, final boolean enable)
throws NoSuchMethodException, InvocationTargetException,
IllegalAccessException {
	Method setWifiApMethod = wifiManager.getClass().getMethod(
		"setWifiApEnabled", WifiConfiguration.class, boolean.class);
	boolean apStatus =
		(boolean)setWifiApMethod.invoke(wifiManager, netConfig, enable);
	return apStatus;
}

int getApState() throws NoSuchMethodException, InvocationTargetException,
IllegalAccessException {
