...
public class CalendarSkillViewFragment
	extends SkillViewFragment<CalendarConditionData> {

private final static String ACTION_RETURN =
	"ryey.easer.skills.condition.calendar.RETURN_FROM_DIALOG";
private final static String EXTRA_CALENDAR_ID =
	"ryey.easer.skills.condition.calendar.extra.calendar_id";
private final static String EXTRA_CALENDAR_NAME =
	"ryey.easer.skills.condition.calendar.extra.calendar_name";
...
public View onCreateView(final @NonNull LayoutInflater inflater,
	...
	View view =
		inflater.inflate(R.layout.plugin_condition__calendar, container, false);
	...
	.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(final View v) {
					...
					0, (loader, data)->{ simpleCursorAdapter.swapCursor(data); });
...
@Override
protected void _fill(final @ValidData @NonNull CalendarConditionData data) {
...
public CalendarConditionData getData() throws InvalidDataInputException {
	...
	CalendarData calendarData =
		new CalendarData(calendar_id, matchType,
		                 ti_event_title_pattern.getText().toString().trim(),
		                 cb_all_day_event.isChecked());
