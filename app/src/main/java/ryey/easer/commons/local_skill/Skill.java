...
public interface Skill<T extends StorageData> {
   ...
   * @return whether all permissions are satisfied (or not); {@code null} for
   *     not requiring any permissions
   */
   ...
   */
  @NonNull DataFactory<T> dataFactory();

  /**
   * Returns the control UI of this plugin.
   * Used in relevant UI.
   */
  @NonNull SkillView<T> view();
}
